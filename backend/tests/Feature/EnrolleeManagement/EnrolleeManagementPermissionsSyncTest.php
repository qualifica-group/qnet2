...
// the 16 RequestManagementPolicy exposes minus `create`, plus spec 0165's
// `viewPrimarySite`) plus the FCR
...
it('permissions:sync creates the 17 enrollee-management abilities, no create (AC-001)', function () {
    $this->artisan('permissions:sync')->assertSuccessful();

    $abilities = RequestModule::Enrollees->abilities();

    expect($abilities)->toHaveCount(17)->not->toContain('create');
