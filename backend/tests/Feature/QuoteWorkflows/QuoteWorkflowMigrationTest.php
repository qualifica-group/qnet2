...
it('rolls back all 7 new migrations cleanly and re-applies them (AC-004)', function () {
    ...
    // before spec 0110 ever touched it — and spec 0111's
    // `2026_09_09_100000_create_employment_product_lines_table` (57th, the
    // rewritten spec 0110 pivot) and
    ...
    // 0126 D-5's
    // `2026_09_14_140000_set_in_validation_task_statuses_completion_percentage`
    // (67th), a data-only migration with no schema of its own, and spec
    // 0124's `2026_09_15_100000_create_task_templates_table` (68th),
    // `2026_09_15_100100_create_task_template_items_table` (69th) and
    ...
    // (83rd), the per-category report column selection, and
    ...
    // then spec 0166's
    // `2026_09_25_100000_create_employment_profile_manager_table` (99th, tied
