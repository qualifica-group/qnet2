...
it('AC-001 (spec 0155): yearly ordinal "2nd Tuesday of March" produces the right date', function () {
    ...
    $dates = (new TaskRecurrenceCalculator)->nextDates($rule, CarbonImmutable::parse('2026-01-01'), limit: 1);
...
it('AC-001 (spec 0155): monthly ordinal 5th Tuesday is skipped in a month without one, never moved', function () {
    ...
    $dates = (new TaskRecurrenceCalculator)->nextDates($rule, CarbonImmutable::parse('2027-01-01'), limit: 1);
...
it('AC-002 (spec 0155): workdays_only never generates a Saturday or a Sunday', function () {
    ...
    // 2026-03-01 is a Sunday: every calendar day for two weeks, minus the
    // weekend ones, is exactly 10 workdays.
    $dates = (new TaskRecurrenceCalculator)->nextDates($rule, CarbonImmutable::parse('2026-03-01'), limit: 10);
