 ...
 * (ProductCategoryForSelectRequest), Resolver call, paginated response.
 ...
 *
 * @see ProductCategoryForSelectResolver::resolve
 */
class ProductCategoryForSelectController extends BaseApiController
{
    ...
    {
        try {
            $result = $this->resolver->resolve($request->toData());
