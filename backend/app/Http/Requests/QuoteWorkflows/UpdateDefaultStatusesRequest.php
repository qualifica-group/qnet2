 ...
 * new custom row. `statuses.*.system_key` carries the OPTIONAL 'validated'
 * mark only (user directive 2026-08-03).
 *
...
class UpdateDefaultStatusesRequest extends FormRequest
{
     ...
     * UpdateQuoteWorkflowData): only a client that actually SENT the key may
     * remove the optional 'validated' mark.
     *
