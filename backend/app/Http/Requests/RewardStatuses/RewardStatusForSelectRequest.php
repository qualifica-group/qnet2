...
/**
 * Validates the query for GET /api/reward-statuses/for-select (ADR 0011,
 * spec 0060 BR-5).
 *
 * Authorization is intentionally NOT handled here (it stays in the controller
 * via authorize('viewAny', RewardStatus::class)). Pagination bounds mirror
 * BaseApiController::validateRequest (offset >= 0, 1 <= limit <= MAX_LIMIT).
 */
class RewardStatusForSelectRequest extends FormRequest
{
    public function authorize(): bool
    {
        // Authorization handled in the controller via the RewardStatusPolicy.
        return true;
    }
