 ...
 * @mixin QuoteWorkflow
 */
class QuoteWorkflowResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        // instantiated directly (`new QuoteWorkflowResource(...)`), so
        // constructor injection is not available here (spec 0047 amendment
        // 2026-07-27 constraint).
        $fieldsByKey = collect(app(QuoteCriterionFieldRegistry::class)->allowedFields())->keyBy('field');
        $valueLabels = app(QuoteCriterionValueLabelResolver::class)->resolve($this->criteria);
