...
namespace App\Tables\TaskImportances;

/**
 * Declarative column/filter/action catalogue for the `task-importances` domain (spec
 * 0101, D-4). Extracted out of TaskImportancesTableDefinition (file-size split,
 ...
 */
final class TaskImportanceColumnCatalog
{
    /**
    ...
    public static function columns(): array
    {
        return [
            [
                'id' => 'name',
                'label' => 'taskImportances.columns.name',
                'type' => 'text',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'description',
                'label' => 'taskImportances.columns.description',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => true,
            ...
            [
                'id' => 'color',
                'label' => 'taskImportances.columns.color',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => false,
            ...
            [
                'id' => 'icon',
                'label' => 'taskImportances.columns.icon',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => false,
            ...
            [
                'id' => 'sort_order',
                'label' => 'taskImportances.columns.sort_order',
                'type' => 'number',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'is_active',
                'label' => 'taskImportances.columns.is_active',
                'type' => 'boolean',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
    ...
    public static function actions(): array
    {
        return [
            ...
            [
                ...
                'type' => 'danger',
                'confirm' => true,
                'permission' => 'task-importances.delete',
            ],
            [
                'key' => 'activity',
                ...
                'type' => 'action',
                'confirm' => false,
                'permission' => 'task-importances.viewActivity',
            ],
        ];
    }
}
