...
namespace App\Tables\TaskCategories;

/**
 * Declarative column/filter/action catalogue for the `task-categories` domain (spec
 * 0101, D-4). Extracted out of TaskCategoriesTableDefinition (file-size split,
...
final class TaskCategoryColumnCatalog
{
    ...
    public static function columns(): array
    {
        return [
            [
                'id' => 'name',
                'label' => 'taskCategories.columns.name',
                'type' => 'text',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'description',
                'label' => 'taskCategories.columns.description',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => true,
            ...
            [
                'id' => 'color',
                'label' => 'taskCategories.columns.color',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => false,
            ...
            [
                'id' => 'icon',
                'label' => 'taskCategories.columns.icon',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => false,
            ...
            [
                'id' => 'sort_order',
                'label' => 'taskCategories.columns.sort_order',
                'type' => 'number',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'is_active',
                'label' => 'taskCategories.columns.is_active',
                'type' => 'boolean',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'created_at',
                'label' => 'taskCategories.columns.created_at',
                'type' => 'datetime',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
    ...
    public static function actions(): array
    {
        return [
            ...
            [
                ...
                'type' => 'danger',
                'confirm' => true,
                'permission' => 'task-categories.delete',
            ],
            [
                'key' => 'activity',
                ...
                'type' => 'action',
                'confirm' => false,
                'permission' => 'task-categories.viewActivity',
            ],
        ];
    }
}
