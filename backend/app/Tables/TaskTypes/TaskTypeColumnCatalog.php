...
namespace App\Tables\TaskTypes;

/**
 * Declarative column/filter/action catalogue for the `task-types` domain (spec
 * 0101, D-4). Extracted out of TaskTypesTableDefinition (file-size split,
 ...
 */
final class TaskTypeColumnCatalog
{
    /**
    ...
    public static function columns(): array
    {
        return [
            ...
            [
                'id' => 'description',
                'label' => 'taskTypes.columns.description',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => true,
            ...
            [
                'id' => 'sort_order',
                'label' => 'taskTypes.columns.sort_order',
                'type' => 'number',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'is_active',
                'label' => 'taskTypes.columns.is_active',
                'type' => 'boolean',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'is_default',
                'label' => 'taskTypes.columns.is_default',
                'type' => 'boolean',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
    ...
    public static function actions(): array
    {
        return [
            ...
            [
                ...
                'type' => 'action',
                'confirm' => false,
                'permission' => 'task-types.viewActivity',
            ],
        ];
    }
}
