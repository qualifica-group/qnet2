 ...
 */
final class RewardStatusColumnCatalog
{
    /**
    ...
    public static function columns(): array
    {
        return [
            [
                'id' => 'name',
                'label' => 'rewardStatuses.columns.name',
                'type' => 'text',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'description',
                'label' => 'rewardStatuses.columns.description',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => true,
            ...
            [
                'id' => 'color',
                'label' => 'rewardStatuses.columns.color',
                'type' => 'text',
                'visible' => true,
                'sortable' => false,
                'filterable' => false,
            ...
            [
                'id' => 'sort_order',
                'label' => 'rewardStatuses.columns.sort_order',
                'type' => 'number',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'is_active',
                'label' => 'rewardStatuses.columns.is_active',
                'type' => 'boolean',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'created_at',
                'label' => 'rewardStatuses.columns.created_at',
                'type' => 'datetime',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
            ...
            [
                'id' => 'updated_at',
                'label' => 'rewardStatuses.columns.updated_at',
                'type' => 'datetime',
                'visible' => true,
                'sortable' => true,
                'filterable' => true,
    ...
    public static function actions(): array
    {
        return [
            ...
            [
                ...
                'type' => 'danger',
                'confirm' => true,
                'permission' => 'reward-statuses.delete',
            ],
            [
                'key' => 'activity',
                ...
                'type' => 'action',
                'confirm' => false,
                'permission' => 'reward-statuses.viewActivity',
            ],
        ];
    }
}
