...
/**
 * Task priority lookup entity (spec 0101, D-4): one of the four PURE Task
...
class TaskPriority extends BaseModel
{
    ...
    /**
     * The Tasks classified under this priority — the "in use" set
     * `TaskPriorityService::delete()` guards against (D-8b).
     *
