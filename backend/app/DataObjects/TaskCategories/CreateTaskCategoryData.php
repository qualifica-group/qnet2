...
/**
 * Validated payload for creating a task category (POST /api/task-categories, spec 0101,
 * D-4). Declared DTO (no "magic flying array") so the StoreTaskCategoryRequest ->
 * TaskCategoryService contract is explicit — see standards/architecture.md ->
 * Data Transfer Objects.
 *
 * `sort_order` is GONE from this DTO: server-managed, placed by
 * TaskCategoryService::create(), never accepted from the client (AC-045).
...
final readonly class CreateTaskCategoryData
{
    ...
    /**
     * Build from the validated StoreTaskCategoryRequest payload.
     *
     ...
     * TaskCategoryService::create(), never carried here.
     *
