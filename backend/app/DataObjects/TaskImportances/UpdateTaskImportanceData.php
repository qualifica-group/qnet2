...
/**
 * Validated payload for a partial (PATCH) task importance update (PUT/PATCH
 * /api/task-importances/{taskImportance}, spec 0101, D-4).
 *
 ...
 */
final readonly class UpdateTaskImportanceData
{
    ...
    /**
     * Build from the validated UpdateTaskImportanceRequest payload.
     *
