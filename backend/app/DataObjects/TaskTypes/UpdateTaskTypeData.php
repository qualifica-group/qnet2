...
/**
 * Validated payload for a partial (PATCH) task type update (PUT/PATCH
 * /api/task-types/{taskType}, spec 0101, D-4).
 *
 ...
 */
final readonly class UpdateTaskTypeData
{
    ...
    /**
     * Build from the validated UpdateTaskTypeRequest payload.
     *
