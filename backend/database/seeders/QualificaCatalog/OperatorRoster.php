...
final class OperatorRoster
{
    ...
    public const array OPERATORS = [
        ...
        ['Gaetano', 'Della Porta', 'gaetano.dellaporta@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Frattamaggiore', self::FRATTAMAGGIORE_HUB, self::CAMPANIA_HUB_CATEGORIES],
        ['Marco', 'Fedele', 'marco.fedele@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Frattamaggiore', self::FRATTAMAGGIORE_HUB, self::CAMPANIA_HUB_CATEGORIES],
        ['Valentina', 'Scala', 'valentina.scala@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Frattamaggiore', self::FRATTAMAGGIORE_HUB, self::CAMPANIA_HUB_CATEGORIES],
        ['Simone', 'Seneca', 'simone.seneca@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Frattamaggiore', self::FRATTAMAGGIORE_HUB, self::CAMPANIA_HUB_CATEGORIES],
        ['Anna', 'Garofalo', 'anna.garofalo@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Frattamaggiore', ['Frattamaggiore'], self::CAMPANIA_HUB_CATEGORIES],
        ['Giulia', 'Costanzo', 'giulia.costanzo@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Frattamaggiore', self::FRATTAMAGGIORE_HUB, self::CAMPANIA_HUB_CATEGORIES],
        ['Lea', 'Pellegrino', 'lea.pellegrino@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Frattamaggiore', self::FRATTAMAGGIORE_HUB, self::CAMPANIA_HUB_CATEGORIES],
        ['Vincenzo', 'Crisci', 'vincenzo.crisci@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Frattamaggiore', self::FRATTAMAGGIORE_HUB, self::CAMPANIA_HUB_CATEGORIES],
        ['Francesca', 'Forgione', 'francesca.forgione@qualificagroup.com', 'Commerciale', Roles::COMMERCIAL_ROLE, 'Benevento', ['Frattamaggiore'], self::CAMPANIA_CATEGORIES],
