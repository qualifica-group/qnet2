...
use App\Http\Controllers\Assignment\RequiredCategoriesController;
use Illuminate\Support\Facades\Route;

/*
|--------------------------------------------------------------------------
| Cross-domain assignment routes (spec 0110)
|--------------------------------------------------------------------------
|
...
|
| The competence requirement of a SELECTION of records, for the three
| assignment surfaces at once (import rows, leads, offers). POST, not GET:
...
*/
Route::post('assignment/required-categories', RequiredCategoriesController::class);
