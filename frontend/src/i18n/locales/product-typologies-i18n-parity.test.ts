...
import { productTypologies as en } from '@/i18n/locales/en-product-typologies'
import { productTypologies as itLocale } from '@/i18n/locales/it-product-typologies'

/**
 * Spec 0088, AC-081: automates what would otherwise be a manual inspection.
...
describe('productTypologies i18n parity (spec 0099 AC-070)', () => {
