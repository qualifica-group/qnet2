...
import { unitsOfMeasure as en } from '@/i18n/locales/en-units-of-measure'
import { unitsOfMeasure as itLocale } from '@/i18n/locales/it-units-of-measure'
...
describe('unitsOfMeasure i18n parity (spec 0088 AC-081)', () => {
