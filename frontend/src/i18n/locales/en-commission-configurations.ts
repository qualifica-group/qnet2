...
export const commissionConfigurations = {
  ...
  form: {
    ...
    product_category_id: 'Product category', product_id: 'Product', recipient_id: 'Recipient', commission_type: 'Commission type',
