...
export const requestManagement = {
  ...
  assignManagerGa3: {
    ...
    empty: 'No results',
    selectError: 'Unable to load users.',
    selectClear: 'Clear selection',
    retry: 'Retry',
    hint: 'Every selected request will receive this {{label}}.',
    clearHint: 'No user selected: confirming clears the slot on every selected request.',
    confirm: 'Assign',
    assigning: 'Assigning...',
    success: 'Assignment updated on {{count}} request(s).',
    errors: {
      generic: 'Unable to complete the assignment. Try again.',
    },
  },
  transfer: {
