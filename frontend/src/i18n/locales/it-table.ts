...
export const table = {
  ...
  favoriteViews: 'Preferiti',
  favoriteView: 'Aggiungi ai preferiti',
  unfavoriteView: 'Rimuovi dai preferiti',
  ...
  // Spec 0158: filtri personalizzati E/O, preferiti e chip dei filtri attivi.
  customFilters: {
    newCustomFilter: 'Nuovo filtro personalizzato',
    builderTitle: 'Filtro personalizzato',
    builderDescription: 'Componi le condizioni, poi applica o salva come vista.',
    andHeading: 'Tutte queste condizioni (E)',
    orHeading: 'Oppure una di queste (O)',
    addCondition: 'Aggiungi condizione',
    removeRule: 'Rimuovi condizione',
    groupEmpty: 'Nessuna condizione in questo gruppo.',
    field: 'Campo',
    operator: 'Operatore',
    value: 'Valore',
    editRules: 'Modifica regole',
    rulesViewIndicator: 'Filtro personalizzato',
    unnamed: 'Filtro personalizzato',
    publishForbidden: 'Non hai il permesso di pubblicare viste condivise.',
    favoriteError: 'Impossibile aggiornare i preferiti.',
    ...
    operators: {
      ...
      lastNDays: 'Negli ultimi N giorni',
      in: 'Uno tra',
      notIn: 'Nessuno tra',
      is: 'È',
    },
    errors: {
      ...
      operator: 'Operatore non valido per questo campo.',
      required: 'Campo obbligatorio.',
      number: 'Inserisci un numero valido.',
      tooLong: 'Massimo 255 caratteri.',
      range: 'Il valore finale deve essere maggiore o uguale a quello iniziale.',
      lastNDays: 'Inserisci un numero intero tra 1 e 366.',
      tooMany: 'Massimo 500 valori.',
      tooManyRules: 'Massimo 20 condizioni per gruppo.',
      atLeastOne: 'Aggiungi almeno una condizione.',
    },
  },
}
