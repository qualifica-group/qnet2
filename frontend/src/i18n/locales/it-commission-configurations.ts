...
export const commissionConfigurations = {
  ...
  form: {
    ...
    product_category_id: 'Categoria prodotto', product_id: 'Prodotto', recipient_type: 'Tipo destinatario', recipient_id: 'Destinatario', commission_type: 'Tipologia commissione',
    ...
    searchProduct: 'Cerca prodotti…', searchRecipient: 'Cerca destinatario…', selectPlaceholder: 'Seleziona…', selectEmpty: 'Nessun risultato.', selectError: 'Impossibile caricare le opzioni.',
    ...
    errors: { nameRequired: 'Il nome configurazione è obbligatorio.', valueInvalid: 'Il valore deve essere maggiore o uguale a zero.', priorityInvalid: 'La priorità deve essere un numero intero.', validFromRequired: 'La data iniziale è obbligatoria.', categoryRequired: 'Seleziona una categoria prodotto.', productRequired: 'Seleziona un prodotto.', recipientRequired: 'Seleziona un destinatario.', validUntilInvalid: 'La data finale non può precedere quella iniziale.', recipientTypeInvalid: 'Questo tipo di destinatario non è ammesso per il ruolo selezionato.' },
  },
  options: {
    recipient_role: { COMMERCIAL: 'Commerciale', REPORTER: 'Segnalatore', SUPERVISOR: 'Supervisore', SUPPLIER: 'Fornitore' },
    application_scope: { PRODUCT_CATEGORY: 'Categoria prodotto', PRODUCT: 'Prodotto', RECIPIENT: 'Destinatario specifico' },
    commission_type: { FIXED_AMOUNT: 'Importo fisso', PERCENTAGE: 'Percentuale' },
    status: { ACTIVE: 'Attiva', SUSPENDED: 'Sospesa' },
    recipient_type: { referent: 'Referente', user: 'Utente', registry: 'Anagrafica' },
  },
}
