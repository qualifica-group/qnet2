...
import { workOrders as en } from '@/i18n/locales/en-work-orders'
import { workOrders as itLocale } from '@/i18n/locales/it-work-orders'

/**
 * Spec 0093, AC-076: automates what would otherwise be a manual inspection.
...
describe('workOrders i18n parity (spec 0093 AC-076)', () => {
