...
export const quotes = {
  ...
  form: {
    ...
    summary: {
      ...
      vat: 'IVA',
      gross: 'Totale',
      marginHint: 'Ricavi netti meno costi netti meno commissioni.',
    ...
    lineAdditionalDescription: 'Descrizione aggiuntiva riga {{n}}',
    lineAdditionalDescriptionAdd: 'Descrizione aggiuntiva',
    lineAdditionalDescriptionPlaceholder: 'Testo aggiuntivo della riga, stampabile nel preventivo',
    lineAdditionalDescriptionRemove: 'Rimuovi descrizione aggiuntiva riga {{n}}',
    ...
    commissions: {
      ...
      selectedRecipient: 'Selezionato sull\'offerta',
