...
export const table = {
  ...
  myViews: 'My views',
  favoriteViews: 'Favorites',
  favoriteView: 'Mark as favorite',
  unfavoriteView: 'Remove from favorites',
  sharedViews: 'Shared',
  ...
  // Spec 0158: AND/OR custom filters, favorites and active-filter chips.
  customFilters: {
    newCustomFilter: 'New custom filter',
    builderTitle: 'Custom filter',
    builderDescription: 'Build the conditions, then apply or save them as a view.',
    andHeading: 'All of these conditions (AND)',
    orHeading: 'Or any of these (OR)',
    addCondition: 'Add condition',
    removeRule: 'Remove condition',
    groupEmpty: 'No condition in this group yet.',
    field: 'Field',
    operator: 'Operator',
    value: 'Value',
    editRules: 'Edit rules',
    rulesViewIndicator: 'Custom filter',
    unnamed: 'Custom filter',
    publishForbidden: 'You do not have permission to publish shared views.',
    ...
    errors: {
      field: 'Invalid field.',
      operator: 'Operator not valid for this field.',
      required: 'This field is required.',
      number: 'Enter a valid number.',
      tooLong: 'Maximum 255 characters.',
      range: 'The end value must be greater than or equal to the start value.',
      lastNDays: 'Enter a whole number between 1 and 366.',
      tooMany: 'Maximum 500 values.',
      tooManyRules: 'Maximum 20 conditions per group.',
      atLeastOne: 'Add at least one condition.',
    },
  },
}
