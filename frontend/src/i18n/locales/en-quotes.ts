...
export const quotes = {
  ...
  detail: {
    ...
    sections: {
      context: 'Context',
      identity: 'Registry and contacts',
      document: 'Document and payment',
    },
    tabs: {
  ...
  form: {
    ...
    summary: {
      ...
      vat: 'VAT',
      gross: 'Gross',
      marginHint: 'Net revenue minus net cost minus commissions.',
    ...
    lineAdditionalDescription: 'Row {{n}} additional description',
    lineAdditionalDescriptionAdd: 'Additional description',
    lineAdditionalDescriptionPlaceholder: 'Extra text for this row, printable in the quote document',
    lineAdditionalDescriptionRemove: 'Remove row {{n}} additional description',
    lineAdd: 'Add row',
    ...
    commissions: {
      ...
      recipient: 'Recipient',
      selectedRecipient: 'Selected on the quote',
