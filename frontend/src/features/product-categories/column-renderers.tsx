 ...
 *
 * `requires_quote`/`is_selectable`/`is_reportable`/`single_quote_per_opportunity`/
 ...
 * would stringify the raw boolean ("true"/"false"). All six reuse the shared
...
export const productCategoryColumnRenderers: TableRendererMap = {
  ...
  is_reportable: (params) => <BooleanBadgeCell {...params} />,
