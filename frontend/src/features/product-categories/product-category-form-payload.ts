...
export function buildCreatePayload(
  ...
  return {
    ...
    inherits_work_order_attributes: values.inherits_work_order_attributes,
...
export function buildUpdatePayload(
  ...
  if (values.inherits_work_order_attributes !== original.inherits_work_order_attributes) {
    payload.inherits_work_order_attributes = values.inherits_work_order_attributes
  }
