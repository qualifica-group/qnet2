...
const guide: HelpGuide = {
  ...
  title: 'Task Importances',
  summary: "A Task Importance indicates a task's relevance.",
  sections: [
    {
      id: 'overview',
      ...
      blocks: [
        {
          type: 'paragraph',
          text: "It is configured in **Configuration › Task Importances** and appears in the task's **Importance** field.",
        },
        {
          type: 'table',
