    ...
    },
    {
      ...
      blocks: [
        ...
        },
        {
          ...
          headers: ['Column', 'Note'],
          rows: [
            ['Unhandled Callbacks, Unhandled New Contacts, Potential Leads', 'They ignore the period and look at the situation today.'],
            ['Calls Made (in period)', ''],
            ['Unhandled Callbacks (in period), Unhandled New Contacts (in period), Potential Leads (in period)', 'The period-bound version of the columns above.'],
            ['Companies Added (in period)', ''],
            ['Enrolled, Deals Closed, Handover Sent (in period)', 'Count requests that moved in the period to a status closed with a positive outcome (details in Request Management › Statistics and reports).'],
        ...
        },
        {
          ...
          items: [
            ...
            'Tick the columns you need; the counter shows how many you chose (for example "5/14"). All and None select or clear them.',
            'Click Save.',
          ],
        },
        {
