  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'paragraph', text: 'Sotto la barra degli strumenti compare una chip per ogni filtro attivo (colonna, avanzato, ricerca, filtro personalizzato): la **x** toglie solo quel filtro, **Azzera tutto** li toglie tutti insieme.' },
