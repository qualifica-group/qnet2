...
const guide: HelpGuide = {
  key: 'task-priorities',
  title: 'Priorità Task',
  summary: "La Priorità Task indica l'urgenza di un task.",
  sections: [
    {
      id: 'overview',
      title: 'A cosa serve',
      blocks: [
        {
          type: 'paragraph',
          text: 'Si configura in **Configurazione › Priorità Task** e compare nel campo **Priorità** del task.',
        },
        {
          type: 'table',
