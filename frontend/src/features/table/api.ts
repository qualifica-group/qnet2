...
export interface UpdateTableCellPayload {
   ...
   * replaces the current one, or — for a multiselect `enum` attribute — the
   ...
   */
  value: string | number | boolean | null | number[] | string[] | Record<string, number>[] | Record<string, number | null>[]
